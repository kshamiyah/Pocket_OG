export const GL861_IOL_FLOWCHART = {
  ...
  nodes: {
    ...
    "crb-check": {
      ...
      items: [
        "Exclusions: ruptured membranes (SROM)",
        "Unstable presenting part not in pelvis",
    ...
    "crb-op": {
      ...
      items: [
        ...
        "Return at 12 hours (or immediately if contractions > period cramps, SROM, decreased fetal movements, pyrexia, unable to pass urine, CRB falls out, or worried)",
    ...
    "crb-review": {
      ...
      text: "After CRB removal — perform VE and reassess. Is ARM now possible? (Cervix favourable / Bishop score ≥ 6)",
      options: [
    ...
    "crb-fail": {
      ...
      text: "CRB has not achieved a favourable cervix. Discuss plan with woman and obstetrician. Is there a history of previous caesarean section?",
      options: [
    ...
    "propess-check": {
      ...
      text: "Is Propess (Dinoprostone 10 mg) appropriate? Note: do NOT give if contractions are already present or CTG is abnormal.",
      options: [
    ...
    "propess-review": {
      ...
      text: "After Propess removal / 24 hours — perform VE and reassess. Is ARM now possible?",
      options: [
        { label: "Yes — ARM possible", next: "arm-head" },
