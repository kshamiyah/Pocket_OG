export const CG623_SECTIONS = [
  {
    ...
    content: [
      ...
      { type: "list", items: ["No significant pain","No intrauterine pregnancy","Unruptured ectopic pregnancy (diagnosed with BHCG and TVS) — mass <35mm, no fetal heart activity","BHCG value <1500 IU/litre — consider conservative management (see Ectopic Pregnancy GL1061)","BHCG values <1500 IU/litre AND conservative management criteria not met or not successful — offer as first line (NICE NG126)","BHCG level 1500–5000 IU/litre — offer MTX or surgery (NICE NG126), haemodynamically stable","Normal LFTs, U&Es and FBC","Failed surgical treatment","Treatment should begin if levels plateau","If levels are rising — exclude intrauterine pregnancy before starting treatment","Patient aware of possible lengthy follow-up (average 35 days) and able to comply"] },
