...

  {
    ...
    content: [
      ...
      { type: "list", items: [
        ...
        "Smoking + age ≥35: UKMEC 3 for CHC if smoking <15 cigarettes/day, UKMEC 4 if ≥15/day — age and smoking compound multiplicatively for VTE and arterial risk, not just additively",
        "Postpartum (not breastfeeding): CHC is UKMEC 3 from day 21 to day 42 postpartum (VTE risk remains elevated), and UKMEC 1 from day 42 onward",
        "Obesity: CHC is UKMEC 2 at BMI 30–34, UKMEC 3 at BMI ≥35 — reflecting the independent VTE contribution of obesity, which is compounded further by any additional risk factor",
      ]},
