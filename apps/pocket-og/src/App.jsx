...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'SF Pro Display', 'Helvetica Neue', sans-serif" }}>
      ...
      {/* CLARK floating launcher */}
      <button
        onClick={() => setShowClark(true)}
        aria-label="Open CLARK clinical co-pilot"
        className="fixed bottom-20 right-5 z-30 w-14 h-14 rounded-full bg-zinc-700 hover:bg-zinc-600 flex items-center justify-center shadow-lg transition-all active:scale-95"
      >
