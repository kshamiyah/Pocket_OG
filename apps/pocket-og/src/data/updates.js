...
export const UPDATES = [
  ...
  },
  {
    ...
    changes: [
      ...
      { tag: "improved", text: "Citations now read \"NG126 1.18.1\" rather than \"NG126 §1.18.1\". The section sign is a legal and academic convention that NICE itself does not use, and it assumed the reader recognised it." },
    ],
  },
  {
    version: "1.23.1",
