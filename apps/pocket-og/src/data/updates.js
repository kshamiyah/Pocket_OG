...
export const UPDATES = [
  {
    ...
    changes: [
      ...
      { tag: "new", text: "On Call is now its own tab with a case library: pick a simulated patient by setting (Maternity Assessment Unit, Delivery Suite) and play through it. New cases cover postpartum haemorrhage (minor, major and massive) and an eclampsia labour-ward emergency, each a single patient moving through several guideline pitfalls, with the reasoning and source on every decision." },
    ],
  },
  {
    version: "1.20.0",
  ...
  },
  {
    ...
    changes: [
      ...
      { tag: "improved", text: "Postmenopausal bleeding: searching \"PMB\" or \"postmenopausal bleeding\" now shows a dedicated topic card and a triage flowchart (2WW, TVUSS 4 mm, pipelle then hysteroscopy), surfacing the existing GTG67 pathway that was previously only reachable under \"Endometrial Hyperplasia\"." },
      { tag: "improved", text: "Uterine fibroids: searching \"fibroids\" now shows a dedicated topic card pulling together the NG88 fibroid pathway, medical options (TXA, GnRH agonists/antagonists, ulipristal) and surgical/interventional options (ablation, UAE, myomectomy, hysterectomy), previously only reachable inside Heavy Menstrual Bleeding." },
      { tag: "new", text: "Endometrial (uterine) cancer (British Gynaecological Cancer Society, 2022): presentation and diagnosis (PMB, TVUSS 4 mm, Lynch testing), TCGA molecular classification (POLE/MMRd/p53abn/NSMP), surgery and staging (total hysterectomy + BSO, sentinel node), risk-adapted adjuvant therapy, and fertility-sparing management. Cross-linked to the GTG67 postmenopausal-bleeding pathway." },
      { tag: "new", text: "Vulval cancer & VIN (British Gynaecological Cancer Society, 2023): aetiology (HPV/usual-type VIN vs HPV-independent differentiated VIN on lichen sclerosus), referral and biopsy, VIN management, wide local excision margins and groin sentinel node surgery, and follow-up. Completes the gynae-oncology set (ovarian, endometrial, cervical, vulval)." },
