...
export const GL891_ANTENATAL_FLOWCHART = {
  ...
  nodes: {
    ...
    "cumulative": {
      ...
      text: "Each factor = 1 point (BMI >40 = 2). Factors: BMI >30, age >35, parity ≥3, smoker, gross varicose veins, current pre-eclampsia, immobility, family history of VTE, multiple pregnancy, IVF/ART, low-risk thrombophilia, transient (dehydration/hyperemesis if admitted, systemic infection, long-distance travel).",
      options: [
