...
export const SIM_CASES = [
  ...
  // reachable only via ?sim=<id> for review). Remove `draft: true` on approval.
  {
    ...
    beats: [
      ...
      },
      {
        kind: "choice",
        time: "21:12",
        narrative: "You feel the fundus: it is soft and high. The weighed swabs come to 700 ml.",
        question: "How do you classify this, and how should it be pitched?",
        fromNode: { fc: "GTG52_PPH", node: "blood_loss" },
        answer: 1,
        why: "Blood loss of 500 to 1000 ml is a minor PPH. A soft (boggy) uterus points to tone, the cause of around 80% of PPH, and the risk factors are all here: a big baby, a prolonged labour and oxytocin augmentation. Minor PPH is managed with immediate measures and close watching, escalating the moment loss approaches 1000 ml or she becomes compromised.",
        source: { gl: "GTG52", sectionId: "gtg52-overview", label: "GTG52 · Definition and classification" },
      },
      {
        kind: "checklist",
        time: "21:14",
        narrative: "You have a minor PPH from a soft uterus, with the placenta already confirmed complete.",
        question: "Which of these are your immediate first steps?",
        items: [
          { label: "Call for help: the midwife in charge and the obstetrician", required: true, why: "Delayed escalation is a recurring contributor in MBRRACE reviews of PPH deaths; calling for help early is one of the highest-impact actions." },
          { label: "Rub up a contraction with bimanual uterine massage", required: true, why: "Tone is the cause, so rubbing up a contraction is a first mechanical measure." },
          ...
          { label: "Call the theatre team and prepare for hysterectomy", required: false, why: "Hysterectomy is a last resort in massive PPH, not a first step in a 700 ml minor bleed." },
          { label: "Observe without treatment and reassess in 30 minutes", required: false, why: "Watchful waiting without treatment risks the delayed escalation repeatedly identified in PPH morbidity and mortality." },
        ],
      ...
      },
      {
        kind: "choice",
        time: "21:16",
        narrative: "The third-stage oxytocin is already in, but bleeding continues from the soft uterus.",
        question: "What is the first-line uterotonic now?",
        options: [
          { label: "Oxytocin: 5 IU IV slowly, then an infusion of 40 IU in 500 ml Hartmann's", sublabel: "First-line for continuing atony" },
          { label: "Carboprost 0.25 mg IM straight away" },
          { label: "Recombinant Factor VIIa" },
          { label: "Misoprostol 800 mcg alone, and nothing further" },
        ],
        answer: 0,
        why: "Oxytocin is first-line: 5 IU IV slowly if not already given, then an infusion of 40 IU in 500 ml Hartmann's. Ergometrine is the next step if oxytocin alone is insufficient (avoided if she were hypertensive). Carboprost belongs to major PPH and Factor VIIa to life-threatening haemorrhage, so neither is first-line here.",
        source: { gl: "GTG52", sectionId: "gtg52-minor", label: "GTG52 · Minor PPH: uterotonics" },
      },
      {
        kind: "choice",
        time: "21:22",
        narrative: "After the contraction is rubbed up and the oxytocin infusion runs, the uterus firms and the bleeding settles. Total loss 800 ml.",
        question: "The bleeding has settled. What now?",
        fromNode: { fc: "GTG52_PPH", node: "minor_response" },
        answer: 0,
        why: "Bleeding is controlled with the initial measures. Continue the oxytocin infusion, keep monitoring observations and lochia, confirm the placenta is complete and the cause (tone) addressed, and escalate only if bleeding restarts or approaches 1000 ml.",
        source: { gl: "GTG52", sectionId: "gtg52-minor", label: "GTG52 · Minor PPH: response to treatment" },
      },
      {
        kind: "lesson",
        title: "The lesson: minor PPH and the 4 Ts",
        summary: "Bea's atonic minor PPH settles with prompt, simple measures done together.",
        points: [
          "Primary PPH is 500 ml or more within 24 hours of birth: 500 to 1000 ml is minor, over 1000 ml is major.",
          "Tone (atony) causes about 80% of PPH; a soft uterus after a big baby and a long augmented labour is the classic picture.",
          "The first moves happen together: call for help early, rub up a contraction, IV access and bloods, catheterise.",
          "Oxytocin is the first-line uterotonic (5 IU IV then a 40 IU infusion); ergometrine next if needed, avoided in hypertension.",
          "Escalate to the major PPH protocol the moment loss approaches 1000 ml or she becomes haemodynamically compromised.",
        ],
        links: [
...

  {
    ...
    patient: {
      ...
      history: "Twin pregnancy delivered vaginally with an overdistended uterus. No hypertension, no asthma. Active third stage given, both placentae complete.",
    },
    beats: [
      {
        kind: "info",
        ...
        narrative: "Both twins are out and well, but the bleeding is brisk and now pooling on the floor. The midwife has already put the buzzer out.",
        dialogue: [
          { who: "midwife", text: "Placentae are complete, but she's pouring and her pulse is climbing." },
        ],
        obs: { "BP": "104/62", "Pulse": "112", "Uterus": "soft" },
      },
      {
        kind: "choice",
        time: "02:42",
        narrative: "The weighed loss is already 1300 ml and still coming. She looks pale and her pulse is 112.",
        question: "How do you classify and respond?",
        fromNode: { fc: "GTG52_PPH", node: "blood_loss" },
        answer: 2,
        why: "Over 1000 ml is a major PPH, and with a rising pulse and falling blood pressure you do not wait. Overdistension from twins is a classic atony risk. Activate the major haemorrhage response now rather than treating this as minor.",
        source: { gl: "GTG52", sectionId: "gtg52-major", label: "GTG52 · Major PPH (over 1000 ml)" },
      },
      {
        kind: "checklist",
        time: "02:44",
        narrative: "You are declaring a major PPH.",
        question: "Which belong in your immediate major-haemorrhage response?",
        items: [
          { label: "Call the senior obstetrician, anaesthetist and senior midwife, and activate the major PPH protocol", required: true, why: "Major PPH needs the senior team and the local protocol activated at once." },
          ...
          { label: "Wait for the FBC and coagulation results before starting treatment", required: false, why: "Do not delay treatment awaiting laboratory results in major PPH." },
          { label: "Delay calling the consultant until bleeding exceeds 2000 ml", required: false, why: "Early consultant involvement is recommended; delayed senior involvement is a recurring MBRRACE finding." },
        ],
      ...
      },
      {
        kind: "choice",
        time: "02:48",
        narrative: "The uterotonic ladder is underway: the oxytocin infusion is running, ergometrine is given and carboprost has been started.",
      ...
      },
      {
        kind: "choice",
        time: "02:55",
        narrative: "The point-of-care fibrinogen returns at 1.3 g/L with bleeding ongoing.",
        question: "What is the first-choice product to correct the fibrinogen?",
        options: [
          { label: "Cryoprecipitate (2 pools)", sublabel: "First choice for fibrinogen below 2 g/L" },
          { label: "FFP alone" },
          { label: "Platelets" },
          { label: "Recombinant Factor VIIa" },
        ],
        answer: 0,
        why: "Cryoprecipitate is the first-choice replacement when fibrinogen is below 2 g/L (2 pools). FFP is for broader coagulopathy or a 1:1 ratio in massive transfusion, platelets when the count falls below 75, and Factor VIIa only in life-threatening haemorrhage not responding to standard measures.",
        source: { gl: "GTG52", sectionId: "gtg52-major", label: "GTG52 · Major PPH: blood products" },
      },
      {
        kind: "choice",
        time: "03:05",
        narrative: "With the uterotonics, TXA and products in, the uterus firms and the bleeding stops. Total loss 1800 ml.",
        question: "The bleeding is controlled. What now?",
        fromNode: { fc: "GTG52_PPH", node: "major_response" },
        answer: 0,
        why: "Haemostasis is achieved with medical management and blood-product support. Continue close monitoring in a high-dependency setting, complete a VTE assessment once bleeding has stopped (VTE risk is high after major PPH), and debrief. Had bleeding continued or passed 2000 ml, this would become a massive PPH needing the massive haemorrhage protocol and surgical options.",
        source: { gl: "GTG52", sectionId: "gtg52-major", label: "GTG52 · Major PPH: haemostasis achieved" },
      },
      {
        kind: "lesson",
        title: "The lesson: running a major PPH",
        summary: "A major atonic PPH after twins, controlled by activating the response early and getting TXA and products in on time.",
        points: [
          "Over 1000 ml is major: activate the response immediately and do not wait for laboratory results.",
          "Act in parallel: seniors and protocol, two large-bore cannulae, crossmatch 4 units, rapid crystalloid, O-negative if life-threatening before crossmatch.",
          "Tranexamic acid 1 g IV as early as possible (within 3 hours), not gated on a fibrinogen result.",
          "Cryoprecipitate is first-choice for fibrinogen below 2 g/L; FFP for broader coagulopathy or 1:1 in massive transfusion.",
    ...
    beats: [
      {
        ...
        time: "04:15",
        title: "Not settling",
        narrative: "Despite the uterotonic ladder and the balloon, Priya is still bleeding. She is cold, and the cannula site has started to ooze.",
        dialogue: [
          { who: "midwife", text: "Full ladder's in and the balloon's up, but she's still losing. That's over two litres now, and she's oozing from the drip site." },
        ],
      ...
      },
      {
        kind: "choice",
        time: "04:16",
        narrative: "Total loss is now over 2000 ml and continuing, with fresh oozing suggesting early coagulopathy.",
        question: "Bleeding controlled?",
        fromNode: { fc: "GTG52_PPH", node: "major_response" },
        answer: 1,
        why: "Ongoing bleeding past 2000 ml despite medical management and tamponade, with new oozing, is a severe and now massive PPH. This triggers the massive haemorrhage protocol and a move towards surgical control, not further waiting.",
        source: { gl: "GTG52", sectionId: "gtg52-massive", label: "GTG52 · Massive PPH / MHP" },
      },
      {
        kind: "checklist",
        time: "04:18",
        narrative: "You are declaring a massive PPH.",
        question: "Which belong in activating the massive haemorrhage protocol?",
        items: [
          { label: "Call the consultant obstetrician, anaesthetist and the haematologist", required: true, why: "In massive PPH deaths reviewed by MBRRACE, the haematologist in particular was often not contacted until coagulopathy was already uncontrollable." },
          ...
          { label: "Keep her warm and correct acidosis and ionised hypocalcaemia (calcium gluconate)", required: true, why: "Hypothermia and hypocalcaemia worsen coagulopathy." },
          { label: "Point-of-care coagulation testing (ROTEM/TEG) to guide product replacement", required: true, why: "Point-of-care testing guides targeted product replacement in real time." },
          { label: "Step down to a normal ward once the balloon is up", required: false, why: "Women surviving massive PPH need HDU or ITU; early step-down risks missing coagulopathy and renal failure (MBRRACE 2025)." },
          { label: "Withhold blood products until the formal clotting screen returns", required: false, why: "Do not delay; use empirical MHP packs and point-of-care testing rather than waiting for formal results." },
        ],
      ...
      },
      {
        ...
        answer: 0,
        why: "She is unstable with ongoing atonic bleeding despite tamponade, so she needs surgical control now: laparotomy with a brace suture (B-Lynch), moving stepwise to pelvic devascularisation and, as a life-saving last resort, hysterectomy. Uterine artery embolisation is for the haemodynamically stable woman, which she is not, so it is the wrong choice here. Factor VIIa is only for life-threatening haemorrhage not responding to standard measures and is no substitute for surgical haemostasis, and re-trialling uterotonics simply wastes time.",
      ...
      },
      {
        ...
        answer: 0,
        why: "After massive PPH she needs HDU or ITU, not an early step-down (MBRRACE found premature step-down led to missed coagulopathy and renal failure). VTE risk is high, so LMWH is given, but only once haemostasis is secure rather than while still bleeding, and not withheld altogether.",
      ...
      },
      {
        ...
        summary: "Priya survives a massive atonic PPH because the team escalates to the massive protocol and to surgery without waiting.",
        points: [
          "Massive PPH (over 2500 ml or any life-threatening loss) triggers the protocol: consultant, anaesthetist and haematologist together, empirical MHP packs, and point-of-care coagulation testing.",
          "Keep her warm and correct acidosis and hypocalcaemia; hypothermia and low calcium worsen coagulopathy.",
        ...
        evidence: "MBRRACE-UK reviews of PPH deaths repeatedly identify delayed escalation, late consultant and haematologist involvement, and premature step-down from critical care as recurring, avoidable contributors.",
        links: [
          { type: "reader", id: "GTG52", label: "GTG52: the full guide" },
          { type: "flowchart", id: "GTG52_PPH", label: "PPH management pathway" },
        ],
