...
export const GL_COLORS = {
  ...
  GTG50:    { badge: "bg-red-50 text-red-700",        border: "border-red-100",      conditionColor: "text-red-500",      icon: "text-red-500",      accent: "bg-red-500",      solid: "bg-red-600",      solidHover: "hover:bg-red-700"      },
  ...
  NG229:    { badge: "bg-red-50 text-red-700",        border: "border-red-100",      conditionColor: "text-red-500",      icon: "text-red-500",      accent: "bg-red-500",      solid: "bg-red-500",      solidHover: "hover:bg-red-600"      },
  BASHH_PID:{ badge: "bg-fuchsia-50 text-fuchsia-700",border: "border-fuchsia-100",  conditionColor: "text-fuchsia-500",  icon: "text-fuchsia-500",  accent: "bg-fuchsia-400",  solid: "bg-fuchsia-600",  solidHover: "hover:bg-fuchsia-700"  },
  NG73:     { badge: "bg-purple-50 text-purple-700",  border: "border-purple-100",   conditionColor: "text-purple-500",   icon: "text-purple-500",   accent: "bg-purple-400",   solid: "bg-purple-600",   solidHover: "hover:bg-purple-700"   },
