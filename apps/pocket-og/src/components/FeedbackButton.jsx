  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 left-5 z-30 flex items-center gap-1.5 bg-white border border-gray-200 shadow-md rounded-full pl-3 pr-3.5 py-2 text-xs font-medium text-gray-400 hover:text-gray-600 hover:shadow-lg transition-all"
      >
