...
export default function TopicCard({ topic, onNavigate, onOpenGuideline }) {
  ...
  return (
    <div className="mb-6 rounded-2xl overflow-hidden bg-white border border-gray-100 shadow-sm">
      <div className={`h-1 ${col.accent}`} />
      <div className="px-4 pt-3.5 pb-3 border-b border-gray-50">
        <div className="flex items-center gap-2">
          <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold tracking-wide uppercase ${col.badge}`}>Topic</span>
