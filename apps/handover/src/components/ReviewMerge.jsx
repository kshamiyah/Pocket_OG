    ...
    <div className={`${SCREEN} px-5`}>
      ...
      <div className={SCREEN_FOOTER} style={safeBottom()}>
        <button
          ...
          className="w-full py-4 rounded-2xl bg-gray-900 dark:bg-white disabled:bg-gray-200 dark:disabled:bg-gray-800 text-white dark:text-gray-950 disabled:text-gray-400 text-base font-bold mb-2 active:scale-95 transition-all"
        >
          Add {chosen.length || ""} to my list
        </button>
        <button onClick={onDiscard} className="w-full py-2.5 text-sm font-medium text-gray-500 dark:text-gray-400">
          Discard
        </button>
      </div>
    </div>
